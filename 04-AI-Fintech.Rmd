...
![Figure 5](pic-5.png "Title")

WE NEED TO ADD A SENTENCE/WORD TO REFER TO FIGURE 3 IN ORDER TO ADD FOOTNOTE^[“Robo-advisors”, accessed 6 May 2022, https://www.statista.com/outlook/dmo/FinTech/digital-investment/robo-advisors/switzerland.]
...
> Among other things, the FinSA requires firms to record, on the one hand, the information collected from clients and the services agreed with and provided to them and, on the other hand, the results of suitability and appropriateness reviews(Art. 15 *et seq.*, FinSA.).
...
![Figure 7](pic-7.png "Title")

If FinTech operates a robo advisor that directly makes an investment decision resulting from the advice given by the algorithm, it is considered to be an asset manager within the meaning of Art. 17 FinIA. In this case the law applies if the FinTech acts in a professional way and not in a private way (see Art. 19 Par. 1 OEFin), which is generally the case ^[@Favrod2021, pp. 185-186.].

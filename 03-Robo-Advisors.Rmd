...
And finally, in this part, we naively illustrate how the robo-advisor would recommend an investment strategy to the client based on the answers to the questionnaire.
```{python eval=FALSE}
    ...
    if source == "DialogCodeHook":
        ...
        if investment_amount is not None:
            ...
            if investment_amount < 5000:
                return build_validation_result(False,"The minimum investment amount is CHF 5000")
            else:

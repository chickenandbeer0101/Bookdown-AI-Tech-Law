...
def portfolio_recommendation(intent_request):
    ...
    if age <18:
        return build_validation_result(False, "You need to be at least 18 years old to use our service")
    elif age >=65:
    ...
    if investment_amount < 5000:
        ...
        return("Based on your answers, we recommend the" {} "investment portfolio")
